...
class CreateResourceGroup(Task):
    def __init__(self,
                 resource_name,
                 resource_handle,
                 section_handle,
                 parent_handle = None):
        Task.__init__(self, 'Creating group \'%s\'' % resource_name)
    ...
    def install(self, environment):
        ...
        try:
            ...
            if not resource:
                ...
                resource = ResourceGroup(self.__resource_name, handle)
...
if __name__ == '__main__':
    ...
    class CreateResourceGroupTest(unittest.TestCase):
        def runTest(self):
    ...
    testcase = CreateResourceGroupTest()
